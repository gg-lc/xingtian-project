...
from xt.structured_pruning.src.pruning_helper_classes import *
from xt.structured_pruning.src.pruning_helper_functions_dense import *
from xt.structured_pruning.src.pruning_helper_functions_conv import *
...
def load_model_param(model):
    ...
    for idx, layer in enumerate(model.layers):
        ...
        if idx != 0:
            if not is_seq:
                # print(idx, model_config['layers'][idx])
